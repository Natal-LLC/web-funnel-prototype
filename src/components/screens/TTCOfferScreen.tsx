...
export function TTCOfferScreen({ timeline }: TTCOfferScreenProps) {
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigate to paywall (plan selection) with email and timeline context
      window.location.href = `/choose-plan?stage=ttc&email=${encodeURIComponent(email)}&timeline=${timeline || ''}`;
    } catch (error) {
